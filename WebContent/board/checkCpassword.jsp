	...
	<table width="250" border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
			...
			<td width="150" bgcolor="#FFFFFF">
				&nbsp;&nbsp;<s:textfield name="cpassword" theme="simple" cssStyle="width:100px" maxlength="20"/>
